...
XI_API_KEY = "d488cd4c207fbc7e59aab06edc4c4d77"  # Your API key for authentication
VOICE_ID = "pNInz6obpgDQGcFmaJgB"  # ID of the voice model to use
AUDIO_FILE_PATH = "a627ea22-f0aa-4b47-911e-c393ce6d2b5a.mp3"  # Path to the input audio file
